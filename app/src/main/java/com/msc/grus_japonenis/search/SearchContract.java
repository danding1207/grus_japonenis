...
public interface SearchContract {
    ...
    interface View extends BaseView {
        ...
        ActivitySearchBinding getActivitySearchBinding();

        void setSearchText(String text);

        void setSearchResult(DestinationsSearch result);
...
//        boolean isActive();
    ...
    abstract class Presenter<T extends View> extends BasePresenter<T> {
        ...
        abstract void serach(String type, String s);

        abstract void destination(int id);

        abstract void destinationTip();

        abstract void plan(int id);

        abstract void planTip();

        abstract void user(int id);
